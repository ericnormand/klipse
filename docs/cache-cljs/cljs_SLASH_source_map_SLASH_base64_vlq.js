...
var digit_13431 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_13432__$1 = (vlq >>> (5));
while(true){
if((vlq_13432__$1 > (0))){
var digit_13433__$1 = (digit_13431 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_13433__$1));

var G__13434 = (vlq_13432__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__13435 = (vlq_13432__$1 >>> (5));
digit_13431 = G__13434;
vlq_13432__$1 = G__13435;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_13431));
}
break;
}
...
var G__13438 = i__$1;
var G__13439 = result__$1;
var G__13440 = shift__$1;
i = G__13438;
result = G__13439;
shift = G__13440;
continue;
