...
var or__20219__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__20219__auto__)){
return or__20219__auto__;
} else {
var or__20219__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__20219__auto____$1)){
return or__20219__auto____$1;
} else {
var or__20219__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__20219__auto____$2)){
return or__20219__auto____$2;
} else {
var or__20219__auto____$3 = (w["msRequestAnimationFrame"]);
if(cljs.core.truth_(or__20219__auto____$3)){
return or__20219__auto____$3;
} else {
...
var self__ = this;
var this$ = this;
var temp__20057__auto__ = (this$[k]);
if((temp__20057__auto__ == null)){
return null;
} else {
var fs = temp__20057__auto__;
(this$[k] = null);

var n__21412__auto__ = fs.length;
var i = (0);
while(true){
if((i < n__21412__auto__)){
(fs[i]).call(null);
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__21075__auto__,writer__21076__auto__,opt__21077__auto__){
return cljs.core._write.call(null,writer__21076__auto__,"reagent.impl.batching/RenderQueue");
});
