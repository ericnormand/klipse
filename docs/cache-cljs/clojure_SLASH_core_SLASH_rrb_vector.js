...
var len__9307__auto___15777 = arguments.length;
var i__9308__auto___15778 = (0);
while(true){
if((i__9308__auto___15778 < len__9307__auto___15777)){
args_arr__9330__auto__.push((arguments[i__9308__auto___15778]));

var G__15779 = (i__9308__auto___15778 + (1));
i__9308__auto___15778 = G__15779;
continue;
} else {
}
break;
...
return clojure.core.rrb_vector.catvec.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),(arguments[(2)]),(arguments[(3)]),argseq__9331__auto__);
...
clojure.core.rrb_vector.catvec.cljs$lang$applyTo = (function (seq15763){
...
var G__15766 = cljs.core.first(seq15763__$2);
var seq15763__$3 = cljs.core.next(seq15763__$2);
var G__15767 = cljs.core.first(seq15763__$3);
var seq15763__$4 = cljs.core.next(seq15763__$3);
return clojure.core.rrb_vector.catvec.cljs$core$IFn$_invoke$arity$variadic(G__15764,G__15765,G__15766,G__15767,seq15763__$4);
});
...
default:
var args_arr__9330__auto__ = [];
var len__9307__auto___15805 = arguments.length;
var i__9308__auto___15806 = (0);
while(true){
if((i__9308__auto___15806 < len__9307__auto___15805)){
args_arr__9330__auto__.push((arguments[i__9308__auto___15806]));

var G__15809 = (i__9308__auto___15806 + (1));
i__9308__auto___15806 = G__15809;
continue;
} else {
}
break;
...
var argseq__9331__auto__ = (new cljs.core.IndexedSeq(args_arr__9330__auto__.slice((4)),(0),null));
return clojure.core.rrb_vector.vector.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),(arguments[(2)]),(arguments[(3)]),argseq__9331__auto__);
...
var arr__15796 = [];
return (new clojure.core.rrb_vector.rrbt.Vector(0,(5),cljs.core.PersistentVector.EMPTY_NODE,arr__15796,null,(0)));
});
...
return (new clojure.core.rrb_vector.rrbt.Vector(1,(5),cljs.core.PersistentVector.EMPTY_NODE,arr__15798,null,null));
});

clojure.core.rrb_vector.vector.cljs$core$IFn$_invoke$arity$2 = (function (x1,x2){
var arr__15799 = [null,null];
(arr__15799[(0)] = x1);

(arr__15799[(1)] = x2);

return (new clojure.core.rrb_vector.rrbt.Vector(2,(5),cljs.core.PersistentVector.EMPTY_NODE,arr__15799,null,null));
});

clojure.core.rrb_vector.vector.cljs$core$IFn$_invoke$arity$3 = (function (x1,x2,x3){
var arr__15800 = [null,null,null];
(arr__15800[(0)] = x1);
...
return (new clojure.core.rrb_vector.rrbt.Vector(3,(5),cljs.core.PersistentVector.EMPTY_NODE,arr__15800,null,null));
});

clojure.core.rrb_vector.vector.cljs$core$IFn$_invoke$arity$4 = (function (x1,x2,x3,x4){
var arr__15801 = [null,null,null,null];
(arr__15801[(0)] = x1);
...
return (new clojure.core.rrb_vector.rrbt.Vector(4,(5),cljs.core.PersistentVector.EMPTY_NODE,arr__15801,null,null));
});
...
clojure.core.rrb_vector.vector.cljs$lang$applyTo = (function (seq15790){
...
return clojure.core.rrb_vector.vector.cljs$core$IFn$_invoke$arity$variadic(G__15791,G__15792,G__15793,G__15794,seq15790__$4);
});
