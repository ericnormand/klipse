...
var and__20196__auto__ = !(("#" === ch));
if(and__20196__auto__){
var and__20196__auto____$1 = !(("'" === ch));
if(and__20196__auto____$1){
var and__20196__auto____$2 = !((":" === ch));
...
if(cljs.core.truth_((function (){var and__20196__auto__ = validate_leading_QMARK_;
...
var G__1456 = (function (){var G__1454 = sb;
G__1454.append(cljs.tools.reader.reader_types.read_char.call(null,rdr));

return G__1454;
})();
var G__1457 = cljs.tools.reader.reader_types.peek_char.call(null,rdr);
sb = G__1456;
ch = G__1457;
continue;
}
...
var temp__19642__auto__ = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if(cljs.core.truth_(temp__19642__auto__)){
var ch = temp__19642__auto__;
var temp__19642__auto____$1 = cljs.tools.reader.edn.dispatch_macros.call(null,ch);
if(cljs.core.truth_(temp__19642__auto____$1)){
var dm = temp__19642__auto____$1;
return dm.call(null,rdr,ch,opts);
} else {
var temp__19642__auto____$2 = cljs.tools.reader.edn.read_tagged.call(null,(function (){var G__1458 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__1458,ch);

return G__1458;
})(),ch,opts);
if(cljs.core.truth_(temp__19642__auto____$2)){
var obj = temp__19642__auto____$2;
return obj;
} else {
...
if(cljs.core.truth_((function (){var or__20219__auto__ = cljs.tools.reader.impl.utils.whitespace_QMARK_.call(null,ch);
if(or__20219__auto__){
return or__20219__auto__;
} else {
var or__20219__auto____$1 = cljs.tools.reader.edn.macros.call(null,ch);
...
var temp__19642__auto__ = cljs.tools.reader.edn.macros.call(null,ch);
if(cljs.core.truth_(temp__19642__auto__)){
var macrofn = temp__19642__auto__;
var mret = macrofn.call(null,rdr,ch,opts);
var G__1467 = ((!((mret === rdr)))?cljs.core.conj_BANG_.call(null,a,mret):a);
a = G__1467;
continue;
} else {
var o = cljs.tools.reader.edn.read.call(null,(function (){var G__1466 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__1466,ch);

return G__1466;
})(),true,null,opts);
var G__1468 = ((!((o === rdr)))?cljs.core.conj_BANG_.call(null,a,o):a);
a = G__1468;
continue;
}
}
...
var iter__21262__auto__ = (function cljs$tools$reader$edn$duplicate_keys_error_$_duplicates_$_iter__1479(s__1480){
return (new cljs.core.LazySeq(null,(function (){
var s__1480__$1 = s__1480;
while(true){
var temp__19804__auto__ = cljs.core.seq.call(null,s__1480__$1);
if(temp__19804__auto__){
var s__1480__$2 = temp__19804__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__1480__$2)){
var c__21260__auto__ = cljs.core.chunk_first.call(null,s__1480__$2);
var size__21261__auto__ = cljs.core.count.call(null,c__21260__auto__);
var b__1482 = cljs.core.chunk_buffer.call(null,size__21261__auto__);
if((function (){var i__1481 = (0);
while(true){
if((i__1481 < size__21261__auto__)){
var vec__1483 = cljs.core._nth.call(null,c__21260__auto__,i__1481);
var id = cljs.core.nth.call(null,vec__1483,(0),null);
var freq = cljs.core.nth.call(null,vec__1483,(1),null);
if((freq > (1))){
cljs.core.chunk_append.call(null,b__1482,id);

var G__1489 = (i__1481 + (1));
i__1481 = G__1489;
continue;
} else {
var G__1490 = (i__1481 + (1));
i__1481 = G__1490;
continue;
}
} else {
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__1482),cljs$tools$reader$edn$duplicate_keys_error_$_duplicates_$_iter__1479.call(null,cljs.core.chunk_rest.call(null,s__1480__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__1482),null);
}
} else {
var vec__1486 = cljs.core.first.call(null,s__1480__$2);
var id = cljs.core.nth.call(null,vec__1486,(0),null);
var freq = cljs.core.nth.call(null,vec__1486,(1),null);
if((freq > (1))){
return cljs.core.cons.call(null,id,cljs$tools$reader$edn$duplicate_keys_error_$_duplicates_$_iter__1479.call(null,cljs.core.rest.call(null,s__1480__$2)));
} else {
var G__1491 = cljs.core.rest.call(null,s__1480__$2);
s__1480__$1 = G__1491;
continue;
}
}
...
return iter__21262__auto__.call(null,cljs.core.frequencies.call(null,seq));
});
...
var sb = (function (){var G__1492 = (new goog.string.StringBuffer());
G__1492.append(initch);
...
var or__20219__auto__ = cljs.tools.reader.impl.commons.match_number.call(null,s);
...
var G__1494 = (function (){var G__1493 = sb;
G__1493.append(ch);

return G__1493;
})();
var G__1495 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__1494;
ch = G__1495;
continue;
}
...
while(true){
var G__1498 = ch;
if(cljs.core._EQ_.call(null,null,G__1498)){
return cljs.tools.reader.reader_types.reader_error.call(null,reader,"EOF while reading string");
} else {
if(cljs.core._EQ_.call(null,"\\",G__1498)){
var G__1501 = (function (){var G__1499 = sb;
G__1499.append(cljs.tools.reader.edn.escape_char.call(null,sb,reader));

return G__1499;
})();
var G__1502 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__1501;
ch = G__1502;
continue;
} else {
...
var G__1503 = (function (){var G__1500 = sb;
G__1500.append(ch);

return G__1500;
})();
var G__1504 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__1503;
ch = G__1504;
continue;
...
var temp__19804__auto__ = cljs.tools.reader.edn.read_token.call(null,rdr,initch);
if(cljs.core.truth_(temp__19804__auto__)){
var token = temp__19804__auto__;
var G__1505 = token;
switch (G__1505) {
case "nil":
return null;
...
break;
default:
var or__20219__auto__ = (function (){var temp__19804__auto____$1 = cljs.tools.reader.impl.commons.parse_symbol.call(null,token);
if(cljs.core.truth_(temp__19804__auto____$1)){
var p = temp__19804__auto____$1;
...
if(cljs.core.truth_((function (){var and__20196__auto__ = s;
if(cljs.core.truth_(and__20196__auto__)){
...
var x__21332__auto__ = sym;
return cljs.core._conj.call(null,(function (){var x__21332__auto____$1 = cljs.tools.reader.edn.read.call(null,rdr,true,null,opts);
return cljs.core._conj.call(null,cljs.core.List.EMPTY,x__21332__auto____$1);
})(),x__21332__auto__);
});
});
...
var G__1508 = rdr;
cljs.tools.reader.edn.read.call(null,G__1508,true,null,true);
...
var temp__19642__auto__ = (function (){var G__1509 = token;
var G__1509__$1 = (((G__1509 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__1509));
if((G__1509__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__1509__$1);
}
})();
if(cljs.core.truth_(temp__19642__auto__)){
var ns = temp__19642__auto__;
var ch = cljs.tools.reader.impl.commons.read_past.call(null,cljs.tools.reader.impl.utils.whitespace_QMARK_,rdr);
if((ch === "{")){
...
var temp__19642__auto__ = (function (){var or__20219__auto__ = cljs.core.get.call(null,new cljs.core.Keyword(null,"readers","readers",(-2118263030)).cljs$core$IFn$_invoke$arity$1(opts),tag);
if(cljs.core.truth_(or__20219__auto__)){
return or__20219__auto__;
} else {
...
if(cljs.core.truth_(temp__19642__auto__)){
var f = temp__19642__auto__;
return f.call(null,object);
} else {
var temp__19642__auto____$1 = new cljs.core.Keyword(null,"default","default",(-1987822328)).cljs$core$IFn$_invoke$arity$1(opts);
if(cljs.core.truth_(temp__19642__auto____$1)){
var d = temp__19642__auto____$1;
...
cljs.tools.reader.edn.read.cljs$core$IFn$_invoke$arity$2 = (function (p__1516,reader){
var map__1517 = p__1516;
...
var opts = map__1517__$1;
var eof = cljs.core.get.call(null,map__1517__$1,new cljs.core.Keyword(null,"eof","eof",(-489063237)));
...
}catch (e1519){if((e1519 instanceof Error)){
var e = e1519;
