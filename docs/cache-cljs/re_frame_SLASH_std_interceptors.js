...
var vec__1012_1015 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_1016 = cljs.core.nth.call(null,vec__1012_1015,(0),null);
var only_after_1017 = cljs.core.nth.call(null,vec__1012_1015,(1),null);
var db_changed_QMARK__1018 = (!((only_before_1016 == null))) || (!((only_after_1017 == null)));
if(db_changed_QMARK__1018){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",(582596132)),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",(-1595516004)),"only before:",only_before_1016);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",(-1595516004)),"only after :",only_after_1017);
...
var map__1019 = new cljs.core.Keyword(null,"coeffects","coeffects",(497912985)).cljs$core$IFn$_invoke$arity$1(context);
var map__1019__$1 = ((((!((map__1019 == null)))?((((map__1019.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__1019.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__1019):map__1019);
var db = cljs.core.get.call(null,map__1019__$1,new cljs.core.Keyword(null,"db","db",(993250759)));
var event = cljs.core.get.call(null,map__1019__$1,new cljs.core.Keyword(null,"event","event",(301435442)));
...
var map__1021 = new cljs.core.Keyword(null,"coeffects","coeffects",(497912985)).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__1021__$1;
var event = cljs.core.get.call(null,map__1021__$1,new cljs.core.Keyword(null,"event","event",(301435442)));
...
var len__21607__auto___1024 = arguments.length;
var i__21608__auto___1025 = (0);
while(true){
if((i__21608__auto___1025 < len__21607__auto___1024)){
args__21610__auto__.push((arguments[i__21608__auto___1025]));

var G__1026 = (i__21608__auto___1025 + (1));
i__21608__auto___1025 = G__1026;
continue;
} else {
}
break;
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq1023){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq1023));
});
...
var args__21610__auto__ = [];
var len__21607__auto___1030 = arguments.length;
var i__21608__auto___1031 = (0);
while(true){
if((i__21608__auto___1031 < len__21607__auto___1030)){
args__21610__auto__.push((arguments[i__21608__auto___1031]));

var G__1032 = (i__21608__auto___1031 + (1));
i__21608__auto___1031 = G__1032;
continue;
} else {
}
break;
...
return cljs.core.get_in.call(null,new_db,p1__26_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__27_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__27_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq1027){
var G__1028 = cljs.core.first.call(null,seq1027);
var seq1027__$1 = cljs.core.next.call(null,seq1027);
var G__1029 = cljs.core.first.call(null,seq1027__$1);
var seq1027__$2 = cljs.core.next.call(null,seq1027__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__1028,G__1029,seq1027__$2);
});
