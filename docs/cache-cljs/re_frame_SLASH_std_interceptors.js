...
var vec__1324_1327 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_1328 = cljs.core.nth.call(null,vec__1324_1327,(0),null);
var only_after_1329 = cljs.core.nth.call(null,vec__1324_1327,(1),null);
var db_changed_QMARK__1330 = (!((only_before_1328 == null))) || (!((only_after_1329 == null)));
if(db_changed_QMARK__1330){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",(582596132)),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",(-1595516004)),"only before:",only_before_1328);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",(-1595516004)),"only after :",only_after_1329);
...
var map__1331 = new cljs.core.Keyword(null,"coeffects","coeffects",(497912985)).cljs$core$IFn$_invoke$arity$1(context);
var map__1331__$1 = ((((!((map__1331 == null)))?((((map__1331.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__1331.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__1331):map__1331);
var db = cljs.core.get.call(null,map__1331__$1,new cljs.core.Keyword(null,"db","db",(993250759)));
var event = cljs.core.get.call(null,map__1331__$1,new cljs.core.Keyword(null,"event","event",(301435442)));
...
var map__1333 = new cljs.core.Keyword(null,"coeffects","coeffects",(497912985)).cljs$core$IFn$_invoke$arity$1(context);
var map__1333__$1 = ((((!((map__1333 == null)))?((((map__1333.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__1333.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__1333):map__1333);
var coeffects = map__1333__$1;
var event = cljs.core.get.call(null,map__1333__$1,new cljs.core.Keyword(null,"event","event",(301435442)));
...
var len__21607__auto___1336 = arguments.length;
var i__21608__auto___1337 = (0);
while(true){
if((i__21608__auto___1337 < len__21607__auto___1336)){
args__21610__auto__.push((arguments[i__21608__auto___1337]));

var G__1338 = (i__21608__auto___1337 + (1));
i__21608__auto___1337 = G__1338;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__21611__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq1335){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq1335));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",(301435442)));
var db = (function (){var or__20219__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",(993250759)));
...
var args__21610__auto__ = [];
var len__21607__auto___1342 = arguments.length;
var i__21608__auto___1343 = (0);
while(true){
if((i__21608__auto___1343 < len__21607__auto___1342)){
args__21610__auto__.push((arguments[i__21608__auto___1343]));

var G__1344 = (i__21608__auto___1343 + (1));
i__21608__auto___1343 = G__1344;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__21611__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__65_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__66_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__66_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq1339){
var G__1340 = cljs.core.first.call(null,seq1339);
var seq1339__$1 = cljs.core.next.call(null,seq1339);
var G__1341 = cljs.core.first.call(null,seq1339__$1);
var seq1339__$2 = cljs.core.next.call(null,seq1339__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__1340,G__1341,seq1339__$2);
});
